...
ConcQueretaro$Nhog <- 1

#DECILES 

#Attaching the data frame
attach(ConcQueretaro) #this is for not writing the name of the data frame and the $ ever time

#Sort Conc according to INGCOR, FOLIOVIV, FOLIOHOG
ConcQueretaro<- orderBy (~+ing_cor+folioviv+foliohog, data=ConcQueretaro) #this give us the households sorted by total income

#Adding the values of the expansion FACTOR. The sum is 34 million, which is the number of households in the country.
tot_hogares<-sum(ConcQueretaro$factor,to.data.frame=TRUE)
...
ConcQueretaro$tam_dec<-tam_dec

# Creating Deciles of Income 

ConcQueretaro$MAXT<-ConcQueretaro$ing_cor #vamos a crear en esta base la variable MAXT que es una copia de la columna de ingresos

ConcQueretaro<-ConcQueretaro[with(ConcQueretaro, order(rank(MAXT))),]  #lo que hicimos aqu? fue reordenar la base con respecto a MAXT. Cosa que en realidad, ya estaba.

ConcQueretaro$ACUMULA<-cumsum(ConcQueretaro$factor) #aqu? creamos una variable de suma acumulada del FACTOR de viviendas.
...
for(i in 1:9)
{
  a1<-ConcQueretaro[dim(ConcQueretaro[ConcQueretaro$ACUMULA<tam_dec*i,])[1]+1,]$factor
  ConcQueretaro<-rbind(ConcQueretaro[1:(dim(ConcQueretaro[ConcQueretaro$ACUMULA<tam_dec*i,])[1]+1),],
                    ConcQueretaro[(dim(ConcQueretaro[ConcQueretaro$ACUMULA<tam_dec*i,])[1]+1):dim(ConcQueretaro[1])[1],])
  
  b1<-tam_dec*i-ConcQueretaro[dim(ConcQueretaro[ConcQueretaro$ACUMULA<tam_dec*i,])[1],]$ACUMULA
  ConcQueretaro[(dim(ConcQueretaro[ConcQueretaro$ACUMULA<tam_dec*i,])[1]+1),]$factor<-b1
  ConcQueretaro[(dim(ConcQueretaro[ConcQueretaro$ACUMULA<tam_dec*i,])[1]+2),]$factor<-(a1-b1)
}

#aqu? estamos creando otra variable de suma acumulada del n?mero de hogares
ConcQueretaro$ACUMULA2<-cumsum(ConcQueretaro$factor)

#aqu? estamos creando una variable que se llama decil que solo tiene ceros
ConcQueretaro$DECIL<-0
...
ConcQueretaro[(ConcQueretaro$ACUMULA2<=tam_dec),]$DECIL<-1
...
for(i in 1:9)
{
  ConcQueretaro[((ConcQueretaro$ACUMULA2>tam_dec*i)&(ConcQueretaro$ACUMULA2<=tam_dec*(i+1))),]$DECIL<-(i+1)
}

# a lo que le qued? cero (que es la ?ltima observaci?n), ponle el decil 10
ConcQueretaro[ConcQueretaro$DECIL%in%"0",]$DECIL<-10

setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Queretaro")
write.dbf(ConcQueretaro,file="ConcQueretaro2010.dbf")
...
setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Queretaro")
write.dbf(ConcQueretaro,file="ConcQueretaro2018.dbf")
...
#reading the data
setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Queretaro")
Conc2010<-read.dbf("ConcQueretaro2010.dbf",as.is = T)
...
write.dbf(c_DECIL_ES,file = "Queretaro por fuente por DECIL estimaciones 2010.dbf")
write.dbf(c_DECIL_SE,file = "Queretaro por fuente por DECIL errores standard 2010.dbf")
write.dbf(c_DECIL_CV,file = "Queretaro por fuente por DECIL CV 2010.dbf")
write.dbf(c_DECIL_LI,file = "Queretaro por fuente por DECIL LI 2010.dbf")
write.dbf(c_DECIL_ES,file = "Queretaro por fuente por DECIL LS 2010.dbf")
...
write.dbf(c_DECIL_ES,file = "Queretaro INDIGENA por fuente por DECIL estimaciones 2010.dbf")
write.dbf(c_DECIL_SE,file = "Queretaro INDIGENA por fuente por DECIL errores standard 2010.dbf")
write.dbf(c_DECIL_CV,file = "Queretaro INDIGENA por fuente por DECIL CV 2010.dbf")
write.dbf(c_DECIL_LI,file = "Queretaro INDIGENA por fuente por DECIL LI 2010.dbf")
write.dbf(c_DECIL_ES,file = "Queretaro INDIGENA por fuente por DECIL LS 2010.dbf")
...
write.dbf(c_DECIL_ES,file = "Queretaro NO por fuente por DECIL estimaciones 2010.dbf")
write.dbf(c_DECIL_SE,file = "Queretaro NO por fuente por DECIL errores standard 2010.dbf")
write.dbf(c_DECIL_CV,file = "Queretaro NO por fuente por DECIL CV 2010.dbf")
write.dbf(c_DECIL_LI,file = "Queretaro NO por fuente por DECIL LI 2010.dbf")
write.dbf(c_DECIL_ES,file = "Queretaro NO por fuente por DECIL LS 2010.dbf")
...
#reading the data
setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Queretaro")
Conc2018<-read.dbf("ConcQueretaro2018.dbf",as.is = T)
...
write.dbf(c_DECIL_ES,file = "Queretaro Ingresos por fuente por DECIL estimaciones 2018.dbf")
write.dbf(c_DECIL_SE,file = "Queretaro Ingresos por fuente por DECIL errores standard 2018.dbf")
write.dbf(c_DECIL_CV,file = "Queretaro Ingresos por fuente por DECIL CV 2018.dbf")
write.dbf(c_DECIL_LI,file = "Queretaro Ingresos por fuente por DECIL LI 2018.dbf")
write.dbf(c_DECIL_ES,file = "Queretaro Ingresos por fuente por DECIL LS 2018.dbf")
...
write.dbf(c_DECIL_ES,file = "Queretaro INDIGENA Ingresos por fuente por DECIL estimaciones 2018.dbf")
write.dbf(c_DECIL_SE,file = "Queretaro INDIGENA Ingresos por fuente por DECIL errores standard 2018.dbf")
write.dbf(c_DECIL_CV,file = "Queretaro INDIGENA Ingresos por fuente por DECIL CV 2018.dbf")
write.dbf(c_DECIL_LI,file = "Queretaro INDIGENA Ingresos por fuente por DECIL LI 2018.dbf")
write.dbf(c_DECIL_ES,file = "Queretaro INDIGENA Ingresos por fuente por DECIL LS 2018.dbf")
...
write.dbf(c_DECIL_ES,file = "Queretaro NO Ingresos por fuente por DECIL estimaciones 2018.dbf")
write.dbf(c_DECIL_SE,file = "Queretaro NO Ingresos por fuente por DECIL errores standard 2018.dbf")
write.dbf(c_DECIL_CV,file = "Queretaro NO Ingresos por fuente por DECIL CV 2018.dbf")
write.dbf(c_DECIL_LI,file = "Queretaro NO Ingresos por fuente por DECIL LI 2018.dbf")
write.dbf(c_DECIL_ES,file = "Queretaro NO Ingresos por fuente por DECIL LS 2018.dbf")
...
Deciles2010<-read.dbf("Queretaro por fuente por DECIL estimaciones 2010.dbf")
names(Deciles2010)[1]<-c("ingcor2010")

Deciles2018<-read.dbf("Queretaro Ingresos por fuente por DECIL estimaciones 2018.dbf")
...
deciles2010No<-read.dbf("Queretaro NO por fuente por DECIL estimaciones 2010.dbf")
names(deciles2010No)[1]<-c("No2010")

deciles2018No<-read.dbf("Queretaro NO Ingresos por fuente por DECIL estimaciones 2018.dbf")
...
deciles2010indigena<-read.dbf("Queretaro INDIGENA por fuente por DECIL estimaciones 2010.dbf")
names(deciles2010indigena)[1]<-c("Indigena2010")

deciles2018indigena<-read.dbf("Queretaro INDIGENA Ingresos por fuente por DECIL estimaciones 2018.dbf")
